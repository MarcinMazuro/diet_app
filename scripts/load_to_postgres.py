...
def load_desired_categories(file_path='archive/desired_categories.json'):
...
def populate_categories_from_desired(conn_params):
    ...
    """
    categories_dict = load_desired_categories('archive/desired_categories.json')
...
if __name__ == '__main__':
    filtered_recipes = load_filtered_recipes('archive/filtered_recipes.json')
